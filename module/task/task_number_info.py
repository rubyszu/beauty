...
def request(variable):
	url = variable["url"]
	task_uuid = variable["task_uuid"]

	api_url = "%s/team/%s/task//info" %(url,variable["team_uuid"],task_uuid)
	headers = {
...
class TestTaskInfo(unittest.TestCase):
	...
	def test_result_200(self):
		...
		# api_schema = GlobalVariable("./api_schema/task/task_uuid_info_200.json").json
		# response_schema = {
