...
def request(variable):
	...
	api_url = "%s/team/%s/project/%s/sprint_field/%s/delete" %(url,team_uuid,project_uuid,field_uuid)
	headers = {
...
class TestGroupSort(unittest.TestCase):
	...
	def test_result_200(self):
		...
		#response body
		api_schema = GlobalVariable("./api_schema/sprint_field/delete_sprint_field_200.json").json
