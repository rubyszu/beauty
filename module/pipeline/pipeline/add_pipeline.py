...
def request(variable):
	...
	api_url = "%s/team/%s/pipelines/add" %(variable["url"],variable["team_uuid"])
	headers = {
...
class TestAddPipeline(unittest.TestCase):
	def setUp(self):
	...
	def test_result_200(self):
		...
		api_schema = GlobalVariable("./api_schema/pipeline/pipeline/add_pipeline_200.json").json
		response_schema = {
